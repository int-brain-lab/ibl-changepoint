...
if isempty(data_list); data_list = get_mice_list(4); end
...
%         };
    model_list = { ...
        'changepoint_contrastnoise_runlength_probs', 'changepoint_contrastnoise', ...
		'omniscient_contrastnoise_fixedfreeprior', 'exponential_contrastnoise' ...    
    }
end
